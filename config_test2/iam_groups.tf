...
module "lz_groups" {
  source = "github.com/oracle-quickstart/terraform-oci-cis-landing-zone-iam//groups?ref=v0.1.7"
...
locals {
  ...
  #-- IAM Admin
  #--------------------------------------------------------------------
  iam_admin_group_key = "${var.service_label}-iam-admins-group"
  default_iam_admin_group_name = "iam-admins-group"
  ...
  #-- Credentials Admin
  #--------------------------------------------------------------------  
  cred_admin_group_key = "${var.service_label}-cred-admins-group"
  default_cred_admin_group_name = "cred-admins-group"
  ...
  #-- Cost Admin
  #--------------------------------------------------------------------
  cost_admin_group_key = "${var.service_label}-cost-admins-group"
  default_cost_admin_group_name = "cost-admins-group"
  ...
  #-- Network Admin
  #--------------------------------------------------------------------
  network_admin_group_key = "${var.service_label}-network-admins-group"
  default_network_admin_group_name = "network-admins-group"
  ...
  #-- Security Admin
  #--------------------------------------------------------------------
  security_admin_group_key = "${var.service_label}-security-admins-group"
  default_security_admin_group_name = "security-admins-group"
  ...
  #-- AppDev Admin
  #--------------------------------------------------------------------
  appdev_admin_group_key = "${var.service_label}-prod-admins-group"
  default_appdev_admin_group_name = "prod-admins-group"
  ...
  #-- Database Admin
  #--------------------------------------------------------------------
  database_admin_group_key = "${var.service_label}-test-admins-group"
  default_database_admin_group_name = "test-admins-group"
...
*/
  ...
  #-- Storage admin
  #------------------------------------------------------------------------
  storage_admin_group_key = "${var.service_label}-storage-admins-group"
  default_storage_admin_group_name = "storage-admins-group"
  ...
  #-- Auditors
  #------------------------------------------------------------------------
  auditor_group_key = "${var.service_label}-auditors-group"
  default_auditor_group_name = "auditors-group"
  ...
  #------------------------------------------------------------------------
  announcement_reader_group_key = "${var.service_label}-announcement-readers-group"
  default_announcement_reader_group_name = "announcement-readers-group"
  ...
  groups_configuration = {
    groups : merge(local.iam_admin_group, local.cred_admin_group, local.cost_admin_group,
                   ...
                   local.storage_admin_group, local.auditor_group, local.announcement_reader_group,local.database_admin_group,local.appdev_admin_group)
  }
