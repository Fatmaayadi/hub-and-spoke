...
locals {
  ...
  #-----------------------------------------------------------
  enclosing_compartment_key = "${var.service_label}-enclosing-cmp"
  ...
  appdev_compartment_key   = "${var.service_label}-prod-cmp"
  ...
  database_compartment_key = "${var.service_label}-test-cmp"
...
*/
  ...
  enclosed_compartments_configuration = {
    ...
    compartments : merge(local.network_cmp, local.security_cmp, local.appdev_cmp, local.database_cmp)
  }
  ...
  custom_enclosing_compartment_name = "enclosing"
  custom_network_compartment_name   = "network"
  custom_appdev_compartment_name    = "prod"
  custom_database_compartment_name  = "test"
  custom_security_compartment_name  = "security"
