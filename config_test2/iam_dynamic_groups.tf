...
locals {
  ...
  custom_security_fun_dyn_group_name        = "sec-fun-dg"
  custom_appdev_fun_dyn_group_name          = "prod-fun-dg"
  custom_appdev_computeagent_dyn_group_name = "prod-computeagent-dg"
  custom_database_kms_dyn_group_name        = "test-kms-dg"
...
locals {
  ...
  #--------------------------------------------------------------------
  appdev_functions_dynamic_group_key = "${var.service_label}-prod-database-kms-dynamic-group"
  default_appdev_functions_dynamic_group_name = "prod-fun-dynamic-group"
  ...
  #--------------------------------------------------------------------
  appdev_computeagent_dynamic_group_key = "${var.service_label}-prod-computeagent-dynamic-group"
  default_appdev_computeagent_dynamic_group_name = "prod-computeagent-dynamic-group"
  ...
  #--------------------------------------------------------------------
  database_kms_dynamic_group_key = "${var.service_label}-test-kms-dynamic-group"
  default_database_kms_dynamic_group_name = "test-kms-dynamic-group"
