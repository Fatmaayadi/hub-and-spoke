...
# ----- Environment
# ------------------------------------------------------
tenancy_ocid         = "ocid1.tenancy.oc1..aaaaaaaaybaroxvhi6u2kygooe3qswfhxfc6q7jo3gyh26r27pl7lfwriq2a"
user_ocid            = "ocid1.user.oc1..aaaaaaaax36xmsskggrlsj4c6puchfkqfiba6mnzgu57zyxrekmhqruarllq"
fingerprint          = "a6:44:26:6a:9b:34:ff:b2:39:88:88:f9:18:55:da:cf"
private_key_path     = "C:/Users/DELL/Downloads/ayadifatma418@gmail.com-2025-07-10T13_34_58.521Z.pem"
...
# ------------------------------------------------------
vcn_cidrs     = ["10.0.0.0/20","10.0.1.0/24","10.0.2.0/24"] # list of CIDRs to be used when creating the VCNs. One CIDR to one VCN. Default: ["10.0.0.0/20"].
vcn_names     = ["VCN-HUB","VCN-SPOKE-PROD","VCN-SPOKE-TEST"] # list of VCN names to override default names with. One name to one CIDR, nth element to vcn_cidrs' nth element. 
subnets_names = ["hubsubnet","spokeprod1,spokeprod2","spoketest1,spoketest2"]
subnets_sizes = [
  [2],        # Pour "hubsubnet"
  [2, 2],    # Pour "spokeprod1", "spokeprod2"
  [2, 2]     # Pour "spoketest1", "spoketest2"
]
...
#dmz_vcn_cidr           = "10.0.0.0/24" # IP range in CIDR notation for the DMZ (a.k.a Hub) VCN.
 #dmz_for_firewall       = true # whether a supported 3rd Party Firewall will be deployed in the DMZ.
 #dmz_number_of_subnets  = 1 # number of subnets in DMZ VCN.
...
# ------------------------------------------------------
 # list of email addresses for all security related notifications.
...
# ------------------------------------------------------
 ...
 cloud_guard_admin_email_endpoints = ["ayadifatma418@gmail.com"] # List of email addresses for Cloud Guard related notifications.
