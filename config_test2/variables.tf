...
variable "subnets_sizes" {
  description = "Liste des tailles de sous-réseaux pour chaque VCN (list of list of numbers)."
...
variable "compartments_configuration" {
  ...
  type        = any
  default     = {}  # Par défaut vide, à surcharger dans input.tfvars
}
variable "policies_configuration" {
  description = "Configuration des policies IAM personnalisées"
  type        = any
  default     = {}
}